...
export function generateTransferReceived(data: BaseEmailData): string {
  ...
  const link = data.depositLink || "https://et.quantumyield.digital/deposit-portal"
  return `
    <!DOCTYPE html>
    <html lang="en">
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="button-section">
            <a href="https://et.quantumyield.digital/deposit-portal" class="action-button">Try Again</a>
          </div>
        </div>
        ${getFooter()}
      </div>
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="button-section">
            <a href="https://et.quantumyield.digital/deposit-portal" class="action-button">Deposit Now</a>
          </div>
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="button-section">
            <a href="https://et.quantumyield.digital/deposit-portal" class="action-button">Start Deposit</a>
          </div>
        </div>
        ${getFooter()}
      </div>
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="button-section">
            <a href="https://et.quantumyield.digital/deposit-portal" class="action-button">Deposit Funds</a>
          </div>
        </div>
        ${getFooter()}
      </div>
...
export function generateTransferReceivedFr(d: BaseEmailData): string {
  const a = d.amount || 0
  const link = d.depositLink || "https://et.quantumyield.digital/deposit-portal"
