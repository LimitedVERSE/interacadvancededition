...
const getHead = (title: string) =>
  `<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>${title}</title>${getEmailStyles()}</head>`
...
const getHeader = () => `
  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#0a0a0a;border-bottom:1px solid #1a1a1a;">
    <tr>
      <!-- Left: Zelle official logo + divider + brand text -->
        ...
        <table cellpadding="0" cellspacing="0" border="0">
          <tr>
            ...
            <td valign="middle">
              <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif;font-size:16px;font-weight:800;color:#ffffff;letter-spacing:-0.01em;line-height:1.2;display:block;padding-bottom:3px;">
                    Zelle
                  </td>
                </tr>
                <tr>
...
function getSendReviewButton(sendLink?: string, transferId?: string): string {
  ...
  const label = transferId
    ? `Review Transfer ${escapeHtml(transferId)}`
...
export function generateTransferReceived(data: BaseEmailData): string {
  ...
  return `
    <!DOCTYPE html>
    <html lang="en">
    ${getHead("Transfer Received — Zelle")}
    <body>
      <div class="container">
        ${getHeader()}
        <div class="content">
          <h1 class="greeting">Hello ${escapeHtml(data.recipientName)},</h1>
          ...
          <div class="details-card">
            ...
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">From:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.senderName || "QuantumYield Treasury")}</td></tr></table>
            ...
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Reference:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.transferId || "ZELLE-000000")}</td></tr></table>
            ${data.message ? `<table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Message:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.message)}</td></tr></table>` : ""}
          </div>

          ${data.securityQuestion ? `
          <div class="security-section">
            <h4 class="security-title">Security Question</h4>
            <p style="color:#555555;font-size:14px;margin-bottom:10px;">${escapeHtml(data.securityQuestion)}</p>
            ${data.securityAnswer ? `<p style="font-size:14px;font-weight:700;color:#000000;letter-spacing:2px;">${escapeHtml(data.securityAnswer)}</p>` : ""}
          </div>` : ""}
...
export function generateTransferSent(data: BaseEmailData): string {
  ...
  return `
    <!DOCTYPE html>
    <html lang="en">
    ${getHead("Transfer Sent Confirmation — Zelle")}
    <body>
      <div class="container">
        ${getHeader()}
        <div class="content">
          ...
          <div class="details-card">
            ...
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">To:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.recipientName)}</td></tr></table>
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Date:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${formatDate()}</td></tr></table>
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Reference:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.transferId || "ZELLE-000000")}</td></tr></table>
...
export function generateTransferPending(data: BaseEmailData): string {
  ...
  return `
    <!DOCTYPE html>
    <html lang="en">
    ${getHead("Transfer Pending — Zelle")}
    <body>
      <div class="container">
        ${getHeader()}
        <div class="content">
          ...
          <div class="details-card">
            <h3 class="details-title">Transfer Details</h3>
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Recipient:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.recipientName)}</td></tr></table>
...
export function generateTransferCancelled(data: BaseEmailData): string {
  ...
  return `
    <!DOCTYPE html>
    <html lang="en">
    ${getHead("Transfer Cancelled — Zelle")}
    <body>
      <div class="container">
        ${getHeader()}
        <div class="content">
          ...
          <div class="details-card">
            ...
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Intended Recipient:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.recipientName)}</td></tr></table>
...
export function generateTransferExpired(data: BaseEmailData): string {
  ...
  return `
    <!DOCTYPE html>
    <html lang="en">
    ${getHead("Transfer Expired — Zelle")}
    <body>
      <div class="container">
        ${getHeader()}
        <div class="content">
...
export function generateDepositCompleted(data: BaseEmailData): string {
  ...
  return `
    <!DOCTYPE html>
    <html lang="en">
    ${getHead("Deposit Completed — Zelle")}
    <body>
      <div class="container">
        ${getHeader()}
        <div class="content">
          ...
          <div class="details-card">
            ...
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">From:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.senderName || "QuantumYield Treasury")}</td></tr></table>
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">To Account:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.bankName || "Primary Chequing")}</td></tr></table>
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Date:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${formatDate()}</td></tr></table>
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Reference:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.transferId || "ZELLE-000000")}</td></tr></table>
...
export function generateDepositReminder(data: BaseEmailData): string {
  ...
  return `
    <!DOCTYPE html>
    <html lang="en">
    ${getHead("Deposit Reminder — Zelle")}
    <body>
      <div class="container">
        ${getHeader()}
        <div class="content">
          <h1 class="greeting">Reminder: Unclaimed e-Transfer</h1>
          <p class="subtitle">Don't forget to deposit your money, ${escapeHtml(data.recipientName)}!</p>
...
export function generateDepositInstructions(data: BaseEmailData): string {
  return `
    <!DOCTYPE html>
    <html lang="en">
    ${getHead("How to Deposit Your Zelle Payment")}
    <body>
      <div class="container">
        ${getHeader()}
        <div class="content">
...
export function generateAutoDepositEnabled(data: BaseEmailData): string {
  ...
  return `
    <!DOCTYPE html>
    <html lang="en">
    ${getHead("Zelle Auto-Deposit Enabled")}
    <body>
      <div class="container">
        ${getHeader()}
        <div class="content">
...
export function generateSecurityQuestionUpdated(data: BaseEmailData): string {
  return `
    <!DOCTYPE html>
    <html lang="en">
    ${getHead("Security Question Updated — Zelle")}
    <body>
      <div class="container">
        ${getHeader()}
        <div class="content">
...
export function generateSuspiciousActivity(data: BaseEmailData): string {
  return `
    <!DOCTYPE html>
    <html lang="en">
    ${getHead("Suspicious Activity Alert — Zelle")}
    <body>
      <div class="container">
        ${getHeader()}
        <div class="content">
          ...
          <div class="details-card">
            ...
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Location:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.location || "Unknown Location")}</td></tr></table>
          </div>
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <p style="color: #666666; font-size: 12px; text-align: center; margin-top: 24px;">
            For security, this request was received from IP: ${escapeHtml(data.location || "Unknown")} on ${formatDate()}
          </p>
        </div>
        ${getFooter()}
      </div>
...
export function generateTwoFactorEnabled(data: BaseEmailData): string {
  return `
    <!DOCTYPE html>
    <html lang="en">
    ${getHead("Two-Factor Authentication Enabled — Zelle")}
    <body>
      <div class="container">
        ${getHeader()}
        <div class="content">
...
export function generateLoginNotification(data: BaseEmailData): string {
  return `
    <!DOCTYPE html>
    <html lang="en">
    ${getHead("New Login Detected — Zelle")}
    <body>
      <div class="container">
        ${getHeader()}
        <div class="content">
          ...
          <div class="details-card">
            ...
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Device:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.deviceInfo || "Chrome on Windows")}</td></tr></table>
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Location:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.location || "Toronto, Canada")}</td></tr></table>
...
export function generateAccountVerified(data: BaseEmailData): string {
  return `
    <!DOCTYPE html>
    <html lang="en">
    ${getHead("Account Verified — Zelle")}
    <body>
      <div class="container">
        ${getHeader()}
        <div class="content">
          <h1 class="greeting">Account Verified!</h1>
          <p class="subtitle">Welcome to Zelle Payment, ${escapeHtml(data.recipientName)}.</p>
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="details-card">
            ...
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Account:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.recipientName)}</td></tr></table>
...
export function generateBankLinked(data: BaseEmailData): string {
  return `
    <!DOCTYPE html>
    <html lang="en">
    ${getHead("Bank Account Linked — Zelle")}
    <body>
      <div class="container">
        ${getHeader()}
        <div class="content">
          ...
          <div class="alert-box alert-success">
            <strong>Connected:</strong> ${escapeHtml(data.bankName || "Your bank account")} is now linked to your profile.
          </div>
          
          <div class="details-card">
            <h3 class="details-title">Linked Account</h3>
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Bank:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.bankName || "Financial Institution")}</td></tr></table>
...
export function generateLimitIncrease(data: BaseEmailData): string {
  return `
    <!DOCTYPE html>
    <html lang="en">
    ${getHead("Transfer Limit Increased — Zelle")}
    <body>
      <div class="container">
        ${getHeader()}
        <div class="content">
          ...
          <div class="amount-box" style="background: linear-gradient(135deg, #17a2b8 0%, #138496 100%);">
            <div class="amount-value">$${escapeHtml(data.limit || "10,000")}</div>
          ...
          <div class="details-card">
            ...
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">New Limit:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">$${escapeHtml(data.limit || "10,000")} USD</td></tr></table>
...
export function generateMoneyRequest(data: BaseEmailData): string {
  ...
  return `
    <!DOCTYPE html>
    <html lang="en">
    ${getHead("Money Request — Zelle")}
    <body>
      <div class="container">
        ${getHeader()}
        <div class="content">
          <h1 class="greeting">Money Request</h1>
          <p class="subtitle">${escapeHtml(data.senderName || "Someone")} is requesting money from you.</p>
          ...
          <div class="details-card">
            ...
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">From:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.senderName || "Requester")}</td></tr></table>
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Amount:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">$${formatAmount(amount)} USD</td></tr></table>
            ${data.message ? `<table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Message:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.message)}</td></tr></table>` : ""}
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Request ID:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.transferId || "REQ-000000")}</td></tr></table>
          </div>
...
export function generateRequestAccepted(data: BaseEmailData): string {
  ...
  return `
    <!DOCTYPE html>
    <html lang="en">
    ${getHead("Request Accepted — Zelle")}
    <body>
      <div class="container">
        ${getHeader()}
        <div class="content">
          ...
          <div class="alert-box alert-success">
            <strong>Success:</strong> ${escapeHtml(data.recipientName || "Someone")} sent you $${formatAmount(amount)} USD.
          </div>
          ...
          <div class="details-card">
            ...
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">From:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.recipientName || "Sender")}</td></tr></table>
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Amount:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">$${formatAmount(amount)} USD</td></tr></table>
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Date:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${formatDate()}</td></tr></table>
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Status:</td><td class="detail-value" style="width:55%;font-size:14px;font-weight:600;padding:10px 0;vertical-align:middle;text-align:right;color:#28a745;">Completed</td></tr></table>
          </div>
...
export function generateRequestDeclined(data: BaseEmailData): string {
  ...
  return `
    <!DOCTYPE html>
    <html lang="en">
    ${getHead("Request Declined — Zelle")}
    <body>
      <div class="container">
        ${getHeader()}
        <div class="content">
          ...
          <div class="alert-box alert-warning">
            <strong>Declined:</strong> ${escapeHtml(data.recipientName || "The recipient")} couldn't fulfill your request.
          </div>
          
          <div class="details-card">
            <h3 class="details-title">Request Details</h3>
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Requested From:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.recipientName || "Recipient")}</td></tr></table>
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Amount:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">$${formatAmount(amount)} USD</td></tr></table>
            <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Date:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${formatDate()}</td></tr></table>
...
export function generateTransferReceipt(data: BaseEmailData): string {
  const amount = data.amount || 0
  return `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Transfer Receipt — Zelle</title>${getEmailStyles()}</head><body>
  <div class="container">${getHeader()}<div class="content">
    ...
    <div class="details-card">
      ...
      <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Receipt No.:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.transferId || "RCPT-" + Date.now().toString().slice(-8))}</td></tr></table>
      <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Recipient:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.recipientName)}</td></tr></table>
      <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Institution:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.institution || "QuantumYield")}</td></tr></table>
...
export function generateTransferReceiptFr(data: BaseEmailData): string {
  const amount = data.amount || 0
  return `<!DOCTYPE html><html lang="fr"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Zelle Payment Notification</title>${getEmailStyles()}</head><body>
  <div class="container">${getHeader()}<div class="content">
    ...
    <div class="details-card">
      ...
      <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">No de reçu :</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.transferId || "RCPT-" + Date.now().toString().slice(-8))}</td></tr></table>
      <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Destinataire :</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.recipientName)}</td></tr></table>
      <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Institution :</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.institution || "QuantumYield")}</td></tr></table>
...
export function generateScheduledTransfer(data: BaseEmailData): string {
  const amount = data.amount || 0
  return `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Scheduled Transfer — Zelle</title>${getEmailStyles()}</head><body>
  <div class="container">${getHeader()}<div class="content">
    ...
    <div class="details-card">
      ...
      <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Reference:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.transferId || "N/A")}</td></tr></table>
...
export function generateScheduledTransferFr(data: BaseEmailData): string {
  ...
  <div class="container">${getHeader()}<div class="content">
    ...
    <div class="details-card">
      ...
      <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Référence :</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.transferId || "S/O")}</td></tr></table>
...
export function generateDepositOnHold(data: BaseEmailData): string {
  const amount = data.amount || 0
  return `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Zelle Payment Notification</title>${getEmailStyles()}</head><body>
  <div class="container">${getHeader()}<div class="content">
...
export function generateTwoFactorCode(data: BaseEmailData): string {
  ...
  <div class="container">${getHeader()}<div class="content">
    ...
    <div class="details-card">
      ...
      <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Issued To:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.recipientName)}</td></tr></table>
...
export function generateTwoFactorCodeFr(data: BaseEmailData): string {
  ...
  <div class="container">${getHeader()}<div class="content">
    ...
    <div class="details-card">
      ...
      <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Émis à :</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.recipientName)}</td></tr></table>
...
export function generateWelcomeOnboard(data: BaseEmailData): string {
  return `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Zelle Payment Notification</title>${getEmailStyles()}</head><body>
  <div class="container">${getHeader()}<div class="content">
    <h1 class="greeting">Welcome, ${escapeHtml(data.recipientName)}!</h1>
    ...
    <div class="details-card">
      ...
      <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Account Holder:</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.recipientName)}</td></tr></table>
...
export function generateWelcomeOnboardFr(data: BaseEmailData): string {
  return `<!DOCTYPE html><html lang="fr"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Zelle Payment Notification</title>${getEmailStyles()}</head><body>
  <div class="container">${getHeader()}<div class="content">
    <h1 class="greeting">Bienvenue, ${escapeHtml(data.recipientName)}!</h1>
    ...
    <div class="details-card">
      ...
      <table class="detail-row" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;border-bottom:1px solid #e9ecef;"><tr><td class="detail-label" style="width:45%;color:#666666;font-size:14px;padding:10px 12px 10px 0;vertical-align:middle;text-align:left;">Titulaire du compte :</td><td class="detail-value" style="width:55%;color:#000000;font-size:14px;font-weight:500;padding:10px 0;vertical-align:middle;text-align:right;">${escapeHtml(data.recipientName)}</td></tr></table>
...
export function generateSettlementConfirmation(d: BaseEmailData): string {
  const a = d.amount || 0
  return `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>Notification Zelle</title>${getEmailStyles()}</head><body><div class="container">${getHeader()}<div class="content">
