...
type BankCategory = "Big Six" | "Online Banks" | "Credit Unions" | "Regional Banks"
...
const CATEGORIES: BankCategory[] = ["Big Six", "Online Banks", "Credit Unions", "Regional Banks"]
...
export default function ConnectBankPage() {
  ...
  const handleBack = () => {
    if (step === "confirm" || step === "connecting" || step === "redirecting") {
      setSelected(null)
      setStep("select")
      setCountdown(5)
    } else {
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-5xl mx-auto px-4 py-8 pb-16">
        ...
        >
          ...
          {step === "select" ? "Back to Dashboard" : "Choose a different bank"}
        </button>
          ...
          <>
            ...
            <div className="mb-10">
              ...
              <p className="text-zinc-500 text-base md:text-lg leading-relaxed max-w-xl">
                Select your financial institution below to securely link your account and receive your e-Transfer deposit.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3 mb-10">
              {TRUST.map(({ icon: Icon, label, sub }) => (
                <div key={label} className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 bg-zinc-50 border border-zinc-200 rounded-xl p-3 sm:p-4">
              ...
              <div className="flex gap-2 overflow-x-auto pb-1 sm:pb-0 shrink-0">
                {(["All", ...CATEGORIES] as const).map((cat) => (
                  <button
                    ...
                    className={`px-3 py-2.5 rounded-xl text-xs font-semibold whitespace-nowrap border transition-all ${
                      activeCategory === cat
            ...
            {step === "confirm" && (
              <>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-[#FDB913] hover:bg-[#e5a811] text-black font-semibold py-4 rounded-xl transition-colors text-base focus:outline-none focus:ring-2 focus:ring-[#FDB913] focus:ring-offset-2"
                >
            ...
            {step === "redirecting" && (
              <div className="text-center py-8">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 bg-[#FDB913] hover:bg-[#e5a811] text-black font-semibold px-6 py-3 rounded-xl transition-colors focus:outline-none focus:ring-2 focus:ring-[#FDB913] focus:ring-offset-2"
                >
                  Continue now
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3 max-w-md">
      ...
      <button
        type="submit"
        disabled={submitting}
        className="flex items-center gap-2 bg-zinc-900 hover:bg-zinc-700 text-white font-semibold px-5 py-3 rounded-xl text-sm transition-colors disabled:opacity-60 focus:outline-none focus:ring-2 focus:ring-zinc-900 focus:ring-offset-2"
      >
